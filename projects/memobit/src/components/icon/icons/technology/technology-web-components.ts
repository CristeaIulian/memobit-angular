...
@Component({
  ...
  template: ` <svg xmlns="http://www.w3.org/2000/svg" width="29.4" height="24" viewBox="0 0 256 209">
    ...
    <path fill="url(#logosWebcomponents0)" d="M96.997 48.898h127.679L196.552.16h-71.43z" opacity="0.95" />
    <path fill="url(#logosWebcomponents1)" d="M182.809 99.874h70.631l-25.408-42.826h-70.791" opacity="0.95" />
    <path fill="url(#logosWebcomponents2)" d="M225.156 158.999H96.838l28.124 48.739h71.909z" opacity="0.95" />
    <path fill="#010101" d="M124.962 207.738L64.878 103.869L125.761 0H59.924L0 103.869l59.924 103.869z" />
    <path fill="url(#logosWebcomponents3)" d="M182.809 108.024h70.631l-25.408 42.825h-70.791" opacity="0.95" />
  </svg>`,
})
export class MemIconTechnologyWebComponentsComponent {}
