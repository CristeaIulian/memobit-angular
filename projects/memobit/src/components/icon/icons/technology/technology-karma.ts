...
@Component({
  ...
  template: ` <svg xmlns="http://www.w3.org/2000/svg" width="31.04" height="24" viewBox="0 0 256 198">
    ...
    <path
      fill="#56c5a8"
      d="m29.492 169.994l45.186-81.62l-28.728 27.084L0 61.23zM249.938.603h-62.043l-37.999 56.144V.603H92.985v58.229l30.344 111.834l7.071 26.483h19.496v-49.138z"
    />
  </svg>`,
})
export class MemIconTechnologyKarmaComponent {}
