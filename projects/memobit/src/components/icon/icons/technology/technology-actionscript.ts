...
@Component({
  selector: 'mem-icon-technology-actionscript',
  template: ` <svg xmlns="http://www.w3.org/2000/svg" width="22.68" height="24" viewBox="0 0 256 271">
    <defs>
...
export class MemIconTechnologyActionscriptComponent {}
