...
@Component({
  selector: 'mem-icon-technology-php-documentor',

  template: `<svg width="30" height="24" viewBox="0 0 46 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
...
export class MemIconTechnologyPhpDocumentorComponent {}
